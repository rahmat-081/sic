...
@if ($jenisJabatan !== 'Pelaksana' and $unitKerja !== 'SDM') 
    ...
    <div class="container">
        <ul class="nav flex-column">
            <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Home</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('atasan.riwayat') }}">Riwayat Pengajuan Cuti</a></li>
...
@if ($jenisJabatan === 'Pelaksana' and $unitKerja === 'SDM')
    ...
    <div class="container">
        <ul class="nav flex-column">
            <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Home</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('jabatan') }}">Riwayat Jabatan</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('karyawan') }}">Karyawan</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('sdm.riwayat') }}">Riwayat Pengajuan Cuti</a></li>
...
@if ($jenisJabatan !== 'Pelaksana' and $unitKerja === 'SDM')
    ...
    <div class="container">
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('karyawan') }}">Karyawan</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('jatahcuti') }}">Jatah Cuti</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('sdm.riwayat') }}">Semua Karyawan Riwayat Pengajuan Cuti</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('atasan.riwayat') }}">Riwayat Pengajuan Cuti</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('approve.pengajuan') }}">Approve Pengajuan Cuti</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('atasan.pengajuan') }}">Pengajuan Cuti</a></li>

                        ...
                        <form method="POST" action="{{ route('karyawan.store') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="NPK" id="npk" name="npk"
                                        aria-label="NPK">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="Tempat Lahir" id="tempatlahir"
                                        name="tempatlahir" aria-label="Tempat Lahir">
                                    <span class="input-group-text"></span>
                                    <input type="date" class="form-control" placeholder="Tanggal Lahir" id="tanggallahir"
                                        name="tanggallahir" aria-label="Tanggal Lahir">
                                </div>
                                <div class="input-group mb-3">
